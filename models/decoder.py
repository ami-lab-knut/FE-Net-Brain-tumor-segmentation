...
class Decoder_2D(nn.Module):
    ...
    def forward(self, out_2d_ar, out_3d_ar):
        ...
        out_2d = out_2d_ar[0]
        out_3d = out_3d_ar[0]
        print('2D shape 1: ', out_2d.shape)
        print('3D shape 1: ', out_3d.shape)
        # print('3d / 2d shapes: ', out_2d.shape, out_3d.shape)
        feats1 = self.corr3(out_2d, out_3d)
        print('correlation out 1: ', feats1.shape)
        x = feats1# + x
        ...
        out_2d = out_2d_ar[1]
        out_3d = out_3d_ar[1]
        print('2D shape 2: ', out_2d.shape)
        print('3D shape 2: ', out_3d.shape)
        feats = self.corr4(out_2d, out_3d)
        print('correlation out 2: ', feats.shape)
        ...
        x = self.outc(x)
        print('final decoder our shape: ', x.shape)
