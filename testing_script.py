...
def set_divisions(selected, total_data, sb):
    ...
    for sf in range(35):
        if sf == sb:
            testing = total_data[sf*35 : sf*35 + 20] # total_data[sf*35 : sf*35 + 20]
...
data_path = 'D:\\brain_tumor_segmentation\\rough_4\\Brain_data_paths_array.npy'
...
folder_path = 'D:\\brain_tumor_segmentation\\weight_saves\\exp\\fold0\\initial_training'
